...
export 'package:hive_plus/src/backend/stub/backend_manager.dart'
    if (dart.library.io) 'package:hive_plus/src/backend/vm/backend_manager.dart'
    if (dart.library.js_interop) 'package:hive_plus/src/backend/js/backend_manager.dart';
